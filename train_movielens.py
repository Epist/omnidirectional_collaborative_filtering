...
from movielens_data_reader import movielens_reader
import keras
...
#Dataset parameters 
data_path = "/data1/movielens/ml-20m/"#'/data1/movielens/ml-20m'
...
print("Loading data")
data_reader = movielens_reader(num_items, num_users, data_path)
